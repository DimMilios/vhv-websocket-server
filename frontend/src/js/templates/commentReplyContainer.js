...
export let commentReplyContainerTemplate = (parent, parentElemWidth) => {
  ...
  return html`
    <div id=${'comment-with-replies-' + parent.id} aria-expanded="false" aria-controls=${collapseId} style="width: 30ch; top: ${parent.highlight.top}px; left:20px; position: absolute;" class="card shadow comment-with-replies" @click=${handleClick}>
